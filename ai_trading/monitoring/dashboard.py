        ...
        try:
            ...
            if not recent_trades:
                ...
                result = {
                    ...
                    "win_rate": win_rate,
                    "avg_pnl_per_trade": realized_pnl / trade_count if trade_count > 0 else 0
                }
...
class DashboardDataProvider:
    ...
    def get_dashboard_data(self, time_range: timedelta = None) -> Dict[str, Any]:
        ...
        try:
            ...
            dashboard_data = {
                ...
                # Performance report
                "performance": self.performance_monitor.get_performance_report(time_range),
    ...
    def get_trading_activity_summary(self, time_range: timedelta = None) -> Dict[str, Any]:
        ...
        try:
            ...
            symbols = set(trade.get("symbol") for trade in recent_trades if trade.get("symbol"))
            strategies = set(trade.get("strategy_id") for trade in recent_trades if trade.get("strategy_id"))
