...
class ModelPromotion:
    ...
    def start_shadow_testing(
        ...
        try:
            ...
            shadow_metrics = PromotionMetrics(last_updated=datetime.now(timezone.utc))
    ...
    def check_promotion_eligibility(self, model_id: str) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            if shadow_start:
                ...
                days_in_shadow = (datetime.now(timezone.utc) - shadow_start_dt).days
            else:
                days_in_shadow = 0
    ...
    def _load_shadow_metrics(self, model_id: str) -> Optional[PromotionMetrics]:
    ...
    def get_active_model_path(self, strategy: str) -> Optional[str]:
...
_global_promotion_manager: Optional[ModelPromotion] = None
