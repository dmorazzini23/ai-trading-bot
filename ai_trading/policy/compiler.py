...
KNOWN_POLICY_KEYS: frozenset[str] = frozenset(
    {
        ...
        *OPTIONAL_KNOB_KEYS.values(),
        ...
        "AI_TRADING_POLICY_ABLATION_ROLLBACK_ENABLED",
        ...
        "AI_TRADING_POLICY_ABLATION_SCHEDULE",
        "AI_TRADING_POLICY_ABLATION_MIN_EVENTS",
        "AI_TRADING_POLICY_ABLATION_NEGATIVE_CONFIDENCE",
        "AI_TRADING_POLICY_ABLATION_MIN_MEAN_EDGE_BPS",
        "AI_TRADING_POLICY_ABLATION_STD_PROXY_BPS",
        "AI_TRADING_POLICY_ABLATION_MAX_SLICES",
        "AI_TRADING_POLICY_ABLATION_ROLLING_DECAY",
        "AI_TRADING_POLICY_ABLATION_ADAPTIVE_THRESHOLD_ENABLED",
