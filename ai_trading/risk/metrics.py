...
class DrawdownAnalyzer:
    ...
    def calculate_drawdowns(self, values: List[float]) -> Dict:
        ...
        try:
            ...
            stats = {
                ...
                'average_drawdown': statistics.mean([dd['magnitude'] for dd in drawdown_periods]) if drawdown_periods else 0,
                'average_recovery_time': statistics.mean([dd['duration'] for dd in drawdown_periods]) if drawdown_periods else 0,
            }
    ...
    def calculate_recovery_time(self, values: List[float], drawdown_start: int, 
                              drawdown_end: int) -> Optional[int]:
        """
