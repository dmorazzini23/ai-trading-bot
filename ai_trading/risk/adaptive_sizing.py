...
class MarketConditionAnalyzer:
    ...
    def analyze_market_regime(self, price_data: Dict[str, List[float]], 
                            volume_data: Optional[Dict[str, List[float]]] = None) -> MarketRegime:
        """
    ...
    def _get_market_proxy(self, price_data: Dict[str, List[float]]) -> Optional[str]:
...
class AdaptivePositionSizer:
    ...
    def calculate_adaptive_position(self, symbol: str, account_equity: float,
        ...
        try:
            ...
            result["metadata"] = {
                ...
                "market_conditions": {
                    ...
                    "correlation_environment": "high" if correlation_penalty > 0.3 else "normal"
                },
                "sizing_rationale": self._generate_sizing_rationale(regime_multiplier, vol_multiplier, correlation_penalty)
            }
            
            logger.info(f"Adaptive sizing for {symbol}: base={base_size}, "
    ...
    def get_regime_based_limits(self, market_regime: MarketRegime) -> Dict[str, float]:
        ...
        if market_regime == MarketRegime.CRISIS:
            return {
                ...
                "max_correlation_exposure": base_limits["max_correlation_exposure"] * 0.5
            }
            ...
            return {
                ...
                "max_correlation_exposure": base_limits["max_correlation_exposure"] * 0.7
            }
            ...
            return {
                ...
                "max_correlation_exposure": base_limits["max_correlation_exposure"] * 1.2
            }
        else:
            return base_limits
    
    def _calculate_correlation_penalty(self, symbol: str, correlation_matrix: Dict[str, float],
    ...
    def _assess_position_risk(self, position_size: int, entry_price: float,
                            account_equity: float, market_data: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "leverage_factor": notional_value / account_equity if account_equity > 0 else 0
            }
    ...
    def _generate_sizing_warnings(self, result: Dict, market_regime: MarketRegime,
    ...
    def _generate_sizing_rationale(self, regime_mult: float, vol_mult: float,
                                 correlation_penalty: float) -> str:
