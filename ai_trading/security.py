...
class SecureConfig:
    ...
    def __init__(self, master_key: Optional[str] = None):
        ...
        self._sensitive_keys = {
            ...
            'NEWS_API_KEY', 'FINNHUB_API_KEY', 'FUNDAMENTAL_API_KEY',
            'IEX_API_TOKEN', 'DATABASE_URL', 'REDIS_URL'
        }
    ...
    def _init_encryption(self) -> Optional['Fernet']:
        ...
        try:
            ...
            salt = b'ai_trading_salt_2024'  # Fixed salt for deterministic key derivation
...
class SafeLogger:
    ...
    def __init__(self, logger: logging.Logger, secure_config: Optional[SecureConfig] = None):
        self.logger = logger
...
class SecurityManager:
    ...
    def __init__(self):
        ...
        self._last_security_check = datetime.now(timezone.utc)
