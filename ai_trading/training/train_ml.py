    ...
    def _fit_final_model(self, X: pd.DataFrame, y: pd.Series) -> None:
        ...
        try:
            ...
            if hasattr(self.model, 'feature_importances_'):
                ...
                self.feature_importance = dict(zip(
                    X.columns, np.abs(self.model.coef_)
                ))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--symbol-list', nargs='+', default=['AAPL', 'MSFT'], 
    ...
    parser.add_argument('--wf-smoke', action='store_true',
                       help='Run walk-forward smoke test')
