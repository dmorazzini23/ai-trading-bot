...
_COLUMN_CANONICAL_MAP = {
    ...
    "pre_market_open": "open",
    "premarket_open": "open",
    "pre_market_open_price": "open",
    "premarket_open_price": "open",
    "start_price": "open",
    "starting_price": "open",
    "bars_open": "open",
    "bar_open": "open",
    ...
    "pre_market_high": "high",
    "premarket_high": "high",
    "pre_market_day_high": "high",
    "premarket_day_high": "high",
    "peak_price": "high",
    "bars_high": "high",
    "bar_high": "high",
    "l": "low",
    ...
    "pre_market_low": "low",
    "premarket_low": "low",
    "pre_market_day_low": "low",
    "premarket_day_low": "low",
    "floor_price": "low",
    "bars_low": "low",
    "bar_low": "low",
    "c": "close",
    ...
    "pre_market_price": "close",
    "premarket_price": "close",
    "pre_market_close": "close",
    "premarket_close": "close",
    "pre_market_last_price": "close",
    "premarket_last_price": "close",
    "pre_market_previous_close": "close",
    "premarket_previous_close": "close",
    "ending_price": "close",
    "end_price": "close",
    "final_price": "close",
    "final_value": "close",
