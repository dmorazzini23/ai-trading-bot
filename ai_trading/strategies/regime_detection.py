...
class RegimeDetector:
    ...
    def detect_regime(self, market_data: pd.DataFrame, 
                     supplementary_data: Dict = None) -> Dict[str, Any]:
        """
    ...
    def _analyze_volatility(self, data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "vol_percentile": self._calculate_volatility_percentile(current_vol, vol_252d)
            }
    ...
    def _analyze_momentum(self, data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "roc_10d": roc_10,
                "roc_20d": roc_20,
                "momentum_strength": self._calculate_momentum_strength(current_rsi, current_macd, roc_20)
            }
    ...
    def _analyze_volume(self, data: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "obv_trend": obv_trend,
                "volume_strength": "high" if volume_ratio_20 > 1.5 else "normal" if volume_ratio_20 > 0.8 else "low"
            }
    ...
    def _determine_primary_regime(self, trend_analysis: Dict, volatility_analysis: Dict, 
                                momentum_analysis: Dict) -> MarketRegime:
        ...
        try:
            ...
            current_vol = volatility_analysis.get("current_vol", 0.2)
            ...
            if (trend_direction == "bullish" and 
                returns_6m > self.trend_thresholds["bull_threshold"] and
                momentum_state in ["bullish", "overbought_bullish"]):
                return MarketRegime.BULL_MARKET
            
            # Bear market detection
            if (trend_direction == "bearish" and 
                returns_6m < self.trend_thresholds["bear_threshold"] and
                momentum_state in ["bearish", "oversold_bearish"]):
                return MarketRegime.BEAR_MARKET
            
            # Recovery detection (coming out of bear market)
            if (trend_direction == "bullish" and 
                momentum_state == "bullish" and 
                returns_6m > -0.05 and returns_6m < 0.10):
                return MarketRegime.RECOVERY
            
            # Sideways/range-bound market
            if (trend_direction == "sideways" and 
                abs(returns_6m) < self.trend_thresholds["sideways_threshold"]):
    ...
    def _detect_secondary_characteristics(self, data: pd.DataFrame, volume_analysis: Dict, 
    ...
    def _calculate_regime_confidence(self, trend_analysis: Dict, volatility_analysis: Dict, 
    ...
    def _calculate_trend_strength(self, returns_1m: float, returns_3m: float, 
                                returns_6m: float, price_vs_sma50: float, 
                                price_vs_sma200: float) -> TrendStrength:
    ...
    def get_regime_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "current_regime": latest["primary_regime"].value if hasattr(latest["primary_regime"], 'value') else str(latest["primary_regime"]),
                "confidence": latest["confidence_score"],
                "stability": stability,
                "secondary_characteristics": latest.get("secondary_characteristics", []),
                "volatility_regime": latest["volatility_analysis"]["regime"].value if hasattr(latest["volatility_analysis"]["regime"], 'value') else str(latest["volatility_analysis"]["regime"]),
        ...
        try:
            ...
            if self.current_regime == MarketRegime.BULL_MARKET:
                ...
                recommendations.update({
                    ...
                    "risk_level": "high",
                    "preferred_strategies": ["mean_reversion", "volatility_trading"],
                ...
                recommendations.update({
                    ...
                    "risk_level": "medium",
                    "preferred_strategies": ["mean_reversion", "range_trading", "pairs"],
