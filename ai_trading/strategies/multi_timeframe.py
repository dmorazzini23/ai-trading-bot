...
class MultiTimeframeSignal:
    ...
    def __init__(self, timeframe: TimeFrame, direction: SignalDirection, 
                 strength: SignalStrength, confidence: float, 
                 indicator: str = "", metadata: Dict = None):
    ...
    def __repr__(self) -> str:
        return (f"Signal({self.timeframe.value}, {self.direction.name}, "
...
class MultiTimeframeAnalyzer:
    ...
    def _analyze_timeframe(self, symbol: str, timeframe: TimeFrame, 
                          data: pd.DataFrame) -> List[MultiTimeframeSignal]:
    ...
    def _generate_ma_signals(self, timeframe: TimeFrame, data: pd.DataFrame) -> List[MultiTimeframeSignal]:
        ...
        try:
            ...
            signals.append(MultiTimeframeSignal(
                timeframe, direction, strength, 0.7,
                "MA_Trend", {"sma_20": sma_20, "sma_50": sma_50}
            ))
            ...
            signals.append(MultiTimeframeSignal(
                timeframe, ema_direction, ema_strength, 0.6,
                "EMA_Crossover", {"ema_12": ema_12, "ema_26": ema_26}
            ))
    ...
    def _generate_rsi_signals(self, timeframe: TimeFrame, data: pd.DataFrame) -> List[MultiTimeframeSignal]:
        ...
        try:
            ...
            signals.append(MultiTimeframeSignal(
                timeframe, direction, strength, confidence,
                "RSI", {"rsi": latest_rsi}
            ))
    ...
    def _generate_macd_signals(self, timeframe: TimeFrame, data: pd.DataFrame) -> List[MultiTimeframeSignal]:
        ...
        try:
            ...
            signals.append(MultiTimeframeSignal(
                timeframe, direction, strength, 0.65,
                "MACD", {"macd": latest_macd, "signal": latest_signal, "histogram": latest_histogram}
            ))
    ...
    def _combine_timeframe_signals(self, symbol: str, 
                                 timeframe_signals: Dict[TimeFrame, List[MultiTimeframeSignal]]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "timeframe_weights": {tf.value: self.hierarchy.get_weight(tf) for tf in timeframe_signals.keys()}
            }
    ...
    def _generate_trading_recommendation(self, combined_analysis: Dict, 
                                       alignment_analysis: Dict) -> Dict[str, Any]:
