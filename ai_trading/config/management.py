    ...
    def from_env(
        ...
        return cls(
            ...
            kelly_fraction_max=_get(
                ...
                float,
                default=0.25,
                aliases=("AI_TRADING_KELLY_FRACTION_MAX", "AI_TRADER_KELLY_FRACTION_MAX"),
            ),
            min_sample_size=_get(
                "MIN_SAMPLE_SIZE",
                int,
                default=10,
                aliases=("AI_TRADING_MIN_SAMPLE_SIZE", "AI_TRADER_MIN_SAMPLE_SIZE"),
            ),
            confidence_level=_get(
                "CONFIDENCE_LEVEL",
                float,
                default=0.90,
                aliases=("AI_TRADING_CONFIDENCE_LEVEL", "AI_TRADER_CONFIDENCE_LEVEL"),
            ),
