...
Centralizes creation and cleanup of thread pools. Avoids oversubscription on
1 vCPU targets and exposes simple module-level attributes.
"""
...
def cleanup_executors() -> None:
    """Cleanup thread pools; never raise during cleanup."""
    global executor, prediction_executor
    try:
