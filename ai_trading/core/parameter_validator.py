...
class ParameterValidator:
    ...
    def validate_parameter_change(self, parameter_name: str, old_value: Any, 
        ...
        try:
            ...
            logger.info(f"Parameter change validation: {parameter_name} {old_value} -> {new_value}, "
    ...
    def _validate_parameter_group(self, parameters: Dict[str, Any], 
    ...
    def _assess_change_impact(self, parameter_name: str, old_value: Any, 
                            new_value: Any) -> Dict[str, str]:
        ...
        risk_decreasing_params = ["STOP_LOSS_MULTIPLIER", "TAKE_PROFIT_MULTIPLIER", "MAX_DRAWDOWN", 
                                "MAX_SLIPPAGE_BPS", "MAX_CORRELATION_EXPOSURE"]
        ...
        if parameter_name in performance_improving_params:
            ...
            if new_value < old_value:
                impact["performance_impact"] = "potentially_improved"  # Lower drawdown = better performance
            elif new_value > old_value:
                impact["performance_impact"] = "potentially_reduced"
