...
try:
    # Tests deliberately set these to None in sys.modules; detect that too:
    import sys
    ...
    if not any(
        ...
        # Try to import to confirm availability
...
# absolutely no client instantiation at import time
trading_client = None
...
def get_git_hash() -> str:
    ...
    try:
        ...
        timeout_s = int(
            os.getenv("SUBPROCESS_TIMEOUT_S", "30") or 30
        )  # AI-AGENT-REF: env default
