...
class MarketRegimeDetector:
    ...
    def detect_regime(self, symbol: str = "SPY") -> RegimeMetrics:
        ...
        try:
            ...
            self.logger.info(
                ...
                regime.value, confidence, trend_metrics.get('strength', 0),
    ...
    def _classify_regime(self, trend_metrics: Dict, volatility_metrics: Dict,
                        momentum_metrics: Dict, mean_reversion_metrics: Dict) -> MarketRegime:
    ...
    def _calculate_confidence(self, trend_metrics: Dict, volatility_metrics: Dict,
                            momentum_metrics: Dict) -> float:
