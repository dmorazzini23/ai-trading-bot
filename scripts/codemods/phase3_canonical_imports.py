...
LEGACY_TO_CANON = {'bot_engine': 'ai_trading.core.bot_engine', 'data_fetcher': 'ai_trading.data_fetcher', 'data_validation': 'ai_trading.data_validation', 'indicators': 'ai_trading.indicators', 'rebalancer': 'ai_trading.rebalancer', 'runner': 'ai_trading.runner', 'signals': 'ai_trading.signals'}
ALLOWED_TOP = ('ai_trading',)
