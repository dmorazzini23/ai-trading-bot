...
def validate_issue_1_meta_learning():
    ...
    logging.info(str("   Problem: 'METALEARN_EMPTY_TRADE_LOG - No valid trades found' despite successful trades"))
...
def validate_issue_4_position_limits():
    ...
    logging.info(str("   Problem: Bot stops at 10 positions with 'SKIP_TOO_MANY_POSITIONS'"))
