...
def main():
    ...
    print("   MACD components: MACD line, Signal line, Histogram")
    
    # Test Bollinger Bands
    upper, middle, lower = ta_lib.BBANDS(price_data)
    print(f"   Bollinger Bands calculated: {len(upper)} values")
    print("   BB components: Upper band, Middle band (SMA), Lower band")
    ...
    print("   The centralized import system successfully provides:")
    print("   • Graceful fallbacks for missing dependencies")
    print("   • Consistent interfaces across mock and real libraries")
    print("   • Full technical analysis capabilities")
    print("   • Machine learning functionality")
    print("   • Mathematical and statistical operations")
    
    print("\n🎯 Benefits:")
    print("   • Trading bot can run in minimal environments")
    print("   • Tests can run without heavy dependencies")
    print("   • Development environments are more flexible")
    print("   • Production deployments are more robust")
