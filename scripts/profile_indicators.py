...
def run_profiles():
    ...
    for module in modules:
        for name, func in inspect.getmembers(module, inspect.isfunction):
            ...
            required_positional = [p for p in sig.parameters.values() if p.default == inspect.Parameter.empty and p.kind in (inspect.Parameter.POSITIONAL_ONLY, inspect.Parameter.POSITIONAL_OR_KEYWORD)]
