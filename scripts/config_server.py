...
def update_config():
    try:
        ...
        pyramid_levels = data.get('pyramid_levels', {'high': 0.4, 'medium': 0.25, 'low': 0.15})
        ...
        return jsonify({'status': 'updated', 'volume_spike_threshold': volume_thr, 'ml_confidence_threshold': ml_thr, 'pyramid_levels': pyramid_levels})
