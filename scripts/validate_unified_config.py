...
def test_settings_singleton():
    """Test settings singleton with Alpaca credentials."""
...
def test_hyperparams_schema():
    ...
    from ai_trading.core.hyperparams_schema import HYPERPARAMS_SCHEMA_VERSION, get_default_hyperparams, load_hyperparams, validate_hyperparams_file
