...
def demo_intelligent_integration():
    ...
    logging.info('\n🔹 POSSIBLE ACTIONS:')
    actions = [('HOLD', 'Continue holding with current strategy'), ('PARTIAL_SELL', 'Take partial profits (scale-out)'), ('FULL_SELL', 'Close entire position'), ('REDUCE_SIZE', 'Reduce position due to risk'), ('TRAIL_STOP', 'Update trailing stop levels'), ('NO_ACTION', 'No changes needed')]
