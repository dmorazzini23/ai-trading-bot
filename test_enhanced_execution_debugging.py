...
try:
    ...
    from ai_trading.execution.debug_tracker import (
        ExecutionDebugTracker, ExecutionPhase, OrderStatus,
        get_debug_tracker, log_signal_to_execution
    )
    from ai_trading.execution.position_reconciler import (
        PositionReconciler, PositionDiscrepancy,
        get_position_reconciler
    )
    from ai_trading.execution.pnl_attributor import (
        PnLAttributor, PnLSource, PnLEvent,
        get_pnl_attributor
    )
...
class TestIntegratedExecutionDebugging(unittest.TestCase):
    ...
    def test_complete_trade_lifecycle_debugging(self):
        ...
        from ai_trading.execution.debug_tracker import log_execution_phase, ExecutionPhase
        ...
        # Record PnL
        from ai_trading.execution.pnl_attributor import record_trade_pnl, update_position_for_pnl
