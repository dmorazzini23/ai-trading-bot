...
> - Real `requests`, `torch`, and other libraries are required. The old `third_party_stubs/` directory and test-only `sitecustomize.py` hook have been removed. Tests skip automatically when optional packages are missing.
