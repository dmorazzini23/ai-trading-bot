...
> - Real `requests`, `torch`, and other libraries are required; the legacy `sitecustomize.py` shim and `third_party_stubs/` directory have been removed. Tests skip automatically when optional packages are missing.
