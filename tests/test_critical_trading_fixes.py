...
class TestLiquidityManagementFixes(unittest.TestCase):
    ...
    def setUp(self):
        self.mock_ctx = Mock()
        self.mock_api = Mock()
        self.execution_engine = ExecutionEngine(self.mock_ctx)
...
def test_order_execution_partial_fill_tracking():
    ...
    engine = ExecutionEngine(mock_ctx, api=mock_api)
