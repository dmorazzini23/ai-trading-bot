...
def test_retrain_meta_learner_success(monkeypatch):
    ...
    monkeypatch.setattr(meta_learning_core, "save_model_checkpoint", lambda m, p: None)
    monkeypatch.setattr(
        meta_learning_core, "load_model_checkpoint", lambda p: {"mock": "model"}
    )
...
def test_retrain_meta_load_history(monkeypatch):
    ...
    monkeypatch.setattr(meta_learning_core, "save_model_checkpoint", lambda *a, **k: None)
    monkeypatch.setattr(meta_learning, "open", lambda *a, **k: io.BytesIO())
    monkeypatch.setattr(meta_learning_core, "load_model_checkpoint", lambda p: {"mock": "model"})
