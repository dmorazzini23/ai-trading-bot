    ...
    def setUp(self):
        ...
        try:
            from ai_trading.risk.adaptive_sizing import (
                MarketConditionAnalyzer, AdaptivePositionSizer, MarketRegime
            )
    ...
    def setUp(self):
        ...
        try:
            from ai_trading.risk.pre_trade_validation import (
                PreTradeValidator, ValidationStatus, MarketHoursValidator,
                LiquidityValidator, RiskValidator
            )
            from ai_trading.core.enums import RiskLevel
    ...
    def setUp(self):
        ...
        try:
            from ai_trading.execution.microstructure import (
                MarketMicrostructureEngine, BidAskSpreadAnalyzer, 
                OrderFlowAnalyzer, MarketRegimeFeature
            )
