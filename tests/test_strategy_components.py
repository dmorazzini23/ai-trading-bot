...
def test_multi_timeframe_analyzer():
    ...
    try:
        from ai_trading.strategies.multi_timeframe import MultiTimeframeAnalyzer, SignalStrength, SignalDirection
...
def test_regime_detector():
    ...
    try:
        from ai_trading.strategies.regime_detection import RegimeDetector, MarketRegime, VolatilityRegime
