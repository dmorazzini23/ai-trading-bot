...
def test_minute_fallback_debug_path_emits_record(caplog, monkeypatch):
    monkeypatch.setattr(bars_mod, "_get_minute_bars", lambda *a, **k: bars_mod.empty_bars_dataframe())
