...
try:
    import config
    from trade_execution import _active_orders, _order_tracking_lock, OrderInfo
except ImportError:
        ...
        try:
            ...
            with self._lock:
                if partial_info.order_id in self._partial_fills:
                    ...
                    self._partial_fills[partial_info.order_id].last_update = datetime.now(timezone.utc)
